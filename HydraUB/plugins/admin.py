...
@HS.on_message(filters.command(["pin","unpin"], prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
...
@HS.on_message(filters.command("invite", prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
...
@HS.on_message(filters.command("admins", prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
...
@HS.on_message(filters.command("del", prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
...
@HS.on_message(filters.command("ban", prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
...
@HS.on_message(filters.command("unban", prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
...
@HS.on_message(filters.command("purge", prefixes=config.HANDLER) & filters.user(config.OWNER_ID))
