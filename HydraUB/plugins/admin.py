...
@HS.on_message(filters.command(["pin","unpin"], prefixes=prefix) & filters.user(DEV_USERS))
...
@HS.on_message(filters.command("invite", prefixes=prefix) & filters.user(DEV_USERS))
...
@HS.on_message(filters.command("admins", prefixes=prefix) & filters.user(DEV_USERS))
...
@HS.on_message(filters.command("del", prefixes=prefix) & filters.user(DEV_USERS))
...
@HS.on_message(filters.command("ban", prefixes=prefix) & filters.user(DEV_USERS))
...
@HS.on_message(filters.command("unban", prefixes=prefix) & filters.user(DEV_USERS))
...
@HS.on_message(filters.command("purge", prefixes=prefix) & filters.user(DEV_USERS))
